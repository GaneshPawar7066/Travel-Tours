    ...
    <div class="container" id="container">
      <div class="form-container sign-up">
        <form>
          ...
          <button onclick="login()"><a href="home.php">Sign Up</a></button>
        </form>
      </div>
      <div class="form-container sign-in">
        <form>
          ...
          <button onclick="login()"><a href="home.php">Sign In</a></button>
        </form>
      </div>
...
// let website_username="samiul";

// let website_password="123456"

// if(usarname = website_username && password2 == website_password){
